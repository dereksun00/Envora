...
const navItems = [
  ...
  { href: "/activities", label: "Activities", icon: "M9 5H7a2 2 0 00-2 2v10a2 2 0 002 2h8a2 2 0 002-2V7a2 2 0 00-2-2h-2M9 5a2 2 0 002 2h2a2 2 0 002-2M9 5a2 2 0 012-2h2a2 2 0 012 2m-6 9l2 2 4-4" },
];
  ...
  return (
    <aside className="fixed left-0 top-0 h-full w-60 bg-gray-900 text-white flex flex-col z-50">
      <div className="p-5 border-b border-gray-700">
        <h1 className="text-xl font-bold tracking-tight">Acme CRM</h1>
      </div>
